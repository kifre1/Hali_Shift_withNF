...
nf_all <- get(load(here("Data/TrawlSurvey_data/abun_nl_all85.Rdata"))) |>
  ungroup() |>
...
write_rds(tows_df, here("Data/Derived/all_unique_tows.rds"), compress = "gz")
...
nf_catch <- get(load(here("Data/TrawlSurvey_data/abun_nl_all85.Rdata"))) |>
  ungroup() |>
...
write_rds(catch_df, here("Data/Derived/all_raw_halibut_catch.rds"), compress = "gz")
...
write_rds(catch_data, here("Data/Derived/all_raw_halibut_catch_formatted.rds"), compress = "gz")
